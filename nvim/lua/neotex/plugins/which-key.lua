	...
	opts = {
		...
		defaults = {
			...
			a = {
				...
				g = {
					name = "glossaries and literature",
					l = { "<cmd>e 01_literaturverzeichnis.bib<CR>", "open Literatur Verzeichnis" },
					s = { "<cmd>e 02_symbolverzeichnis.tex<CR>", "open Symbol Verzeichnis" },
					a = { "<cmd>e 03_abkuerzungsverzeichnis.tex<CR>", "open Abkürzungs Verzeichnis" },
					i = { "<cmd>e 04_indizesverzeichnis.tex<CR>", "open Indize Verzeichnis" },
					g = { "<cmd>e 05_glossar.tex<CR>", "open Glossar" },
				},
				...
				n = { "<cmd>TermExec cmd='source ~/master-thesis/bin/activate'<CR>", "activate python venv" },
			...
			t = {
				...
				b = {
					"<cmd>read ~/.config/nvim/templates/beamer.tex<CR>",
					"beamer.tex",
				},
				s = {
